...
export function buildPrStudioImageSearchRequest(parsed) {
  ...
  return {
    ...
    instructions: [
      "Act as a publication photo editor conducting visual research, not as a keyword matcher. The goal is to find photographs that visually tell the article's story.",
      ...
      "Before searching, infer three to six distinct visual search hypotheses from the article context. A hypothesis should describe a concrete scene, historical episode, person in action, place, object in use, archival record, production moment or other visually meaningful situation.",
      "Treat the supplied searchQueries as thematic seeds, not final queries. Preserve coverage of the supplied themes, but do not merely paraphrase or slightly shorten the seeds.",
      "When the number of supplied thematic seeds is six or fewer, test at least one materially different visual hypothesis for each relevant seed before spending additional searches on another seed.",
      "Expand thematic seeds with article-specific anchors from title, mainIdea, summary and contentExcerpt: named people, founders, family members, locations, dates, factories, workshops, products, materials, books, exhibitions, sourcing journeys, milestones, inventions, historical events and other concrete episodes actually supported by the article context.",
      "Use three to six short searches. Each search must test a different visual search hypothesis or retrieval path; do not return several lexical variants of the same idea.",
      "Shape searches as exact named entity plus concrete object plus action where useful, for example: company name + founder + workshop, company name + historical workers + machinery, company name + material inspection + archive, or company name + anniversary book + archival photographs.",
      ...
      "For a history or heritage direction, strongly prefer archival or documentary photographs showing people, action, equipment, materials, early workplaces, sourcing, inspection, historical production, founders or family members in meaningful context, or an artifact that documents a concrete episode.",
      "For history or heritage, an old photograph is not automatically a strong result. The visible scene itself should communicate a meaningful episode in the subject's history, not merely be old or come from a page containing the words history, heritage or archive.",
      "Prefer photographs that still communicate some of the story when the caption is removed. A documented group with relevant equipment, materials or human action is usually stronger than a generic factory facade, isolated fabric, animal, landscape, current shop, advertising campaign or finished-product shot.",
      "For modern production or craft directions, prefer real human action, inspection, handling of material and identifiable work processes over generic interiors or posed brand imagery.",
      ...
      "When a named company, person, place, product or material is present, preserve the exact name in multiple searches where it improves recall. For non-English subjects, search in English and the relevant local language when useful.",
      "Prefer the named subject's official site, official publications, primary sources, museums, archives, library or collection pages, Wikimedia Commons file pages, anniversary books or book features, and reputable specialist or editorial publications. Official pages with unclear reuse rights are still relevant candidates and must not be discarded for that reason.",
      "For historical subjects, actively look for image-rich archive, museum, anniversary, retrospective, book-review and specialist-history pages that may reproduce primary photographs unavailable on a current corporate product page.",
      "Reject generic press-kit templates, unrelated newsrooms, concerts, celebrities, abstract graphics and pages that merely contain words such as editorial or illustration. Animals, landscapes, shops and product shots are weak unless the specific scene is genuinely necessary to tell the selected article theme.",
      "Look for a strong hero image with one readable subject or one coherent documentary scene and a clear connection to the article's argument. Do not select logos, separators, generic banners or tiny thumbnails.",
      ...
      "In candidatePages return only webpages you actually opened through web search and judged directly relevant. Prefer pages likely to contain the concrete visual scene being sought, not merely pages that discuss the topic in text. Do not return search-result pages or invented URLs.",
