...
const TOPTRY_SEED_LOOKS = [
  ...
  },
  {
    ...
    title: "Рубашка, пиджак и деловые брюки",
    gender: "MALE",
    items: [
      { label: "пиджак", subgroups: ["BLAZERS"], colors: ["beige", "blue", "gray"], preferredMerchants: ["finnflare", "thecultt"], excludedMerchants: ["sportmaster"] },
